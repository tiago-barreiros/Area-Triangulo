...
> Uma pequena aplicação para o cálculo da área do
triângulo, através da formula de Heron.
...
[![Java][Java]][Java-url] [![JavaFX][JavaFX]][JavaFX-url] [![NetBeans][NetBeans]][NetBeans-url] [![Swing][Swing]][Swing-url] [![FXML][FXML]][FXML-url] [![SceneBuilder][SceneBuilder]][SceneBuilder-url]
...
Após a entrega deste projeto ficará publico :  https://github.com/tiago-barreiros/Area-Triangulo
...
- [FXML](https://docs.oracle.com/javafx/2/fxml_get_started/jfxpub-fxml_get_started.htm)
- [Scene Builder](https://docs.gluonhq.com/scenebuilder/)
- [Scene Builder - Tutorial](https://www.youtube.com/watch?v=Z1W4E2U42Sw)
...
## [Prof. Doutor João Paulo Cordeiro](https://www.di.ubi.pt/~jpaulo/)

## *Interação Humana com o Computador* @[Universidade da Beira Interior](https://www.ubi.pt/).
